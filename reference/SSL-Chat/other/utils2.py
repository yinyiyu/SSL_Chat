...
if __name__ == '__main__':
    ...
    msg = 'langlanglanglnsjdjajsdjfjajsdjfjajsdjfjasdklfjajsdkfjlkjalsdjfajsdjfjalsjdfjasdjfjasdjfkl\n'
    msg = msg+msg
    with open('msg/msg.txt','a+') as f:
        f.write(msg)

    print('测试加密后的消息'+encrypt('msg/msg.txt',client_encode_dst_file,server_public_key))
